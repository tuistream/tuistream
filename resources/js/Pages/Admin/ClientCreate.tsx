...
import {
    ...
    Phone, AtSign, ShieldCheck, Bell, UserCog, ToggleLeft
} from 'lucide-react';
...
export default function ClientCreate() {
    ...
    return (
        <AdminLayout currentPage="clients">
            <Head title="Crear Cliente - Admin TuiStream" />
            ...
            <div className="mb-6">
                ...
                >
                    <ArrowLeft className="w-3.5 h-3.5" /> Volver a la lista de clientes
                </Link>
            </div>
            ...
            <div className="max-w-2xl">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-white">Crear Nuevo Cliente</h1>
                        <p className="text-sm text-slate-500 mt-1">Registrar una nueva cuenta en el sistema</p>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-slate-900 bg-slate-900/20 backdrop-blur-sm p-6 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div
                            onClick={() => setData('send_welcome_email', !data.send_welcome_email)}
                        ...
                        >
                            <div className={`w-9 h-5 rounded-full relative transition-all duration-300 flex-shrink-0 ${
                                data.send_welcome_email ? 'bg-indigo-500' : 'bg-slate-700'
                            }`}>
                                <div className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-all duration-300 ${
                                    data.send_welcome_email ? 'left-4' : 'left-0.5'
                                }`} />
                            </div>
                            <div>
                                <p className="text-xs font-bold text-slate-300 flex items-center gap-1.5">
                                    <Bell className="w-3.5 h-3.5 text-indigo-400" />
                                    Enviar mail con credenciales y bienvenida
                                </p>
                                <p className="text-[10px] text-slate-500 mt-0.5">
                                    Se enviará un correo al cliente con sus datos de acceso y un mensaje de bienvenida.
                                </p>
                            </div>
                        </div>
