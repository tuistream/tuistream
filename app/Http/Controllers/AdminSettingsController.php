...
class AdminSettingsController extends Controller
{
    private array $defaultSettings = [
        ...
        'nginx_rtmp_httpport' => ['value' => '80', 'type' => 'integer', 'group' => 'plugins'],
        'nginx_rtmp_rtmpport' => ['value' => '1935', 'type' => 'integer', 'group' => 'plugins'],
        ...
        'icecast_executable' => ['value' => '/usr/bin/icecast', 'type' => 'string', 'group' => 'plugins'],
        'icecast_share_path' => ['value' => '/usr/share/icecast', 'type' => 'string', 'group' => 'plugins'],
        'icecast_admin_user' => ['value' => 'admin', 'type' => 'string', 'group' => 'plugins'],
